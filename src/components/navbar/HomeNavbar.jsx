...
function HomeNavbar() {
    ...
    return(
        <>
            ...
            <a to="/main" className="text-white text-center">
               CCT
            </a>
            <div className="flex flex-col justify-between flex-1 mt-6">
                ...
                >
                    ...
                    <span className="mx-2 text-sm font-medium">Rating Tasks</span>
                </Link>
                ...
                >
                    ...
                    <span className="mx-2 text-sm font-medium">Candidates Consensus</span>
                </Link>
